...
//
//        ConfidentialClientApplication app = ConfidentialClientApplication.builder(config.getClientId(), cred)
//                .authority(config.getAuthorityUrl())
//                .setTokenCacheAccessAspect(new DatabaseTokenCache(systemUser, tokenCacheRepository))
//                .build();

//        IClientCredential cred = ClientCredentialFactory.createFromCertificate(certificateAndKey.privateKey, certificateAndKey.certificate);
