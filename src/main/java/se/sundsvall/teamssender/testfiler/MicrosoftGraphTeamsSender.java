...
public class MicrosoftGraphTeamsSender {
    ...
    public MicrosoftGraphTeamsSender(OboTokenService oboTokenService, String userAccessToken, String senderEmail) {
        this.graphClient = new GraphServiceClient(
            new OboAuthenticationProvider(oboTokenService, userAccessToken, senderEmail)
        );
    }
